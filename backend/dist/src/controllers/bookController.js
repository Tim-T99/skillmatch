...
exports.createBook = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        // check if book exists
        const titleCheck = yield db_config_1.default.query("SELECT book_id FROM books WHERE title = $1", [title]);
        if (titleCheck.rows.length > 0) {
            res.status(400).json({
                message: "book already exists"
            });
        ...
        const eventResult = yield db_config_1.default.query(`INSERT INTO events (title, author, isbn, year, pages, publisher, description, image, price, created_by) 
...
exports.getBooks = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield db_config_1.default.query("SELECT * FROM books");
...
exports.getBookById = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const result = yield db_config_1.default.query("SELECT * FROM books WHERE book_id=$1", [id]);
...
exports.updateBook = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const resultCCheck = yield db_config_1.default.query("SELECT * FROM books WHERE book_id=$1", [id]);
        ...
        const result = yield db_config_1.default.query("UPDATE books SET title=$1, author =$2, isbn =$3, year=$4, pages=$5, publisher=$6, description=$7, image=$8, price=$9, created_by=$10, updated_at=NOW() WHERE book_id=$11 RETURNING *", [title, author, isbn, year, pages, publisher, description, image, price, created_by, id]);
...
exports.deleteBook = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield db_config_1.default.query("DELETE FROM books  WHERE book_id=$1", [id]);
